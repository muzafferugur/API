...
public class WriteToText {
    public static void saveSSNData(String fileName, GMIBankCustomerPojo[] customers) {
        try {
    ...
    public static void saveEmailData(String fileName, GMIBankCustomerPojo[] customers) {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(fileName, false));
    ...
    public static void saveCustomersData(String fileName, GMIBankCustomerPojo[] customers) {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(fileName, false));
